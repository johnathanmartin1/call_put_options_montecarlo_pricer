...
//void Contract::PutValue(const std::unique_ptr<Contract>& obj)
//{
//	std::vector<double> priceplus;
//	std::vector<double> priceminus;
//	double valueerror{};
//	valueerror = PutValueError(obj->getPrices());
//	for (double val : obj->getPrices())
//	{
...
//	averagevalue = PutValueCalc(obj->getPrices());
...
//void Contract::CallValue(const std::unique_ptr<Contract>& obj)
//{
//	std::vector<double> priceplus;
//	std::vector<double> priceminus;
//	double valueerror{};
//	valueerror = CallValueError(obj->getPrices());
//	for (double val : obj->getPrices())
//	{
//		priceplus.push_back(val - valueerror);
//		priceminus.push_back(val + valueerror);
...
//	averagevalue = CallValueCalc(obj->getPrices());
...
//void Contract::AverageStrikePrice(const std::unique_ptr<Contract>& obj)
//{
//	std::cout << "Average assest price at strike time :" << char(156) << Mean(obj->getPrices()) 
//		<< "    ( +- " << StDev(obj->getPrices())*1.96 <<" )\n\n";
//}
//
